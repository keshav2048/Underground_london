...
from mst import kruskal as MST
...
for edge in edges:
    try:  # Inserts the edge with it's weight
...
mini = mst.kruskal(graph1)

"""Using the task 3 on the data of reduced stations """
for i in vertices:
    d, pi = dijkstra(mini, vertices.index(i))
